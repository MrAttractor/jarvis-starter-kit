# VSD, où l'argent rentre pour Mr Attractor

> Analyse du 23/07/2026, à la demande de Mac Arthur : « analyse toutes les poches d'entrée claires ».
> Contexte : la formule de revenue sharing avec J'Envoie Express n'est pas arrêtée, et tant qu'elle
> ne l'est pas, il faut savoir ce qui rentre à coup sûr et ce qui dépend d'une négociation.
>
> Chiffres recalculés sur les hypothèses du `simulateur-convoyeurs.html`, valise à 99 €.
...
## 2. Les poches, classées par degré de certitude
...
### Poche D, à construire : la revente du modèle

Ce que nous construisons n'est pas un vol, c'est **un système reproductible** : plateforme, marque, méthode de sélection, cadre juridique, argumentaire compagnie.

- Même montage sur **une autre ligne** (Dakar, Douala, Cotonou, Bamako) avec une autre compagnie
- Même montage **en marque blanche** pour un autre opérateur de fret
- La **base de voyageurs** qualifiés de la diaspora, qui vaut pour tout le reste de l'écosystème

Aucun euro aujourd'hui, mais c'est la seule poche qui ne dépend ni de J'Envoie Express ni de la compagnie. **C'est là qu'est la valeur de sortie.**

### Ce qui n'est pas une poche, et qu'il ne faut jamais compter

- **Le prix du billet** : c'est la recette de la compagnie, il ne fait que transiter.
- **Le chiffre d'affaires du fret** : c'est l'exploitation de J'Envoie Express, remboursée au kilo avant partage.
- **La commission hôtel** : volontairement écartée le 23/07, elle ferait basculer l'offre dans un régime réglementé.

---

## 3. La formule de revenue sharing à proposer

Le principe qui rend la discussion simple : **chacun se fait payer ce qu'il apporte, avant qu'on partage ce qui reste.**

J'Envoie Express apporte un **travail variable** : collecte, emballage, pesée, manifeste, dernier kilomètre. Il est déjà payé pour ça, au kilo, avant partage (2 660 € par rotation). C'est normal et ce n'est pas contesté.

Mr Attractor apporte un **actif** : la plateforme, la marque VSD, la relation et la négociation avec la compagnie, la campagne d'acquisition, la sélection des voyageurs. Aujourd'hui, cet actif n'est rémunéré nulle part : seule la campagne est remboursée (400 €), le reste est censé se payer sur la part de résultat.

**La proposition, en deux étages :**
...
>
> À 40/60 sur le résultat fret, Mr Attractor tombe à 50 973 € par an et J'Envoie Express monte, tout en gardant ses 2 660 € d'opérations remboursés par rotation. C'est le point d'équilibre à viser.
...
## 5. Ce qu'il faut sécuriser en priorité

1. **Écrire que les frais de réservation et les valises sont encaissés par Mr Attractor et ne rentrent pas dans le pot commun.** C'est la seule chose qui transforme un revenu incertain en revenu certain.
2. **Obtenir le tarif fret de la compagnie par écrit.** Sans lui, tous les chiffres de ce document sont des hypothèses.
3. **Obtenir le coût opérationnel réel de J'Envoie Express.** Sans lui, la part de résultat est un chiffre en l'air.
4. **Ne pas signer de clé de partage avant d'avoir fait tourner deux ou trois rotations réelles.** Un partage négocié sur des hypothèses se renégocie mal. Un partage négocié sur des chiffres constatés ne se conteste pas.
