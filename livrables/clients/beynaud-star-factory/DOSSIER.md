...
| D-15 | **Un direct ne peut pas être réservé.** `launchLive` écrit `grade_requis:'membre'` en dur (`app.html:1169`), et il n'existe que deux grades dont le second s'obtient gratuitement | **rien de payant ne peut être vendu**, ni direct ni replay | ouvert, **bloquant pour le 5 décembre** |
