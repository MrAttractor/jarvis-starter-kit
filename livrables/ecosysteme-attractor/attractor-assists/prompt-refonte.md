...
- **Écosystème (frise narrative) :** Attractor Assists est le **premier panneau** (*Penser*) d'une frise : Assist → Livraison Pro (*Délivrer*) → Fidelys (*Fidéliser*) → Dashboard (*Piloter*). Designs complémentaires sur une colonne vertébrale partagée. Détail : `livrables/ecosysteme-attractor/notes/frise-narrative.md`. Concevoir des tokens partagés, déclinables en cohérence sur les autres apps.
