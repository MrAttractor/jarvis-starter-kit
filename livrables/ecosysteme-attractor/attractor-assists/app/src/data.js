export const MOCK = {
  ...
  assistants: [
    {
      id: "coach", genre: "m", name: "Mr Attractor", role: "Ton bras droit", plan: "Découverte", status: "actif", accent: "orange", icon: "compass", photo: null,
      desc: "Il est là 24h/24. Dis-lui ce que tu as en tête — il organise, priorise, produit.",
    ...
    {
      id: "carelle", genre: "f", name: "Carelle", role: "Chief of Staff · Direction", plan: "Growth", status: "verrouillé", accent: "charbon", icon: "flag", photo: "/uploads/agents/carelle.jpg",
    ...
    {
      id: "miriam", genre: "f", name: "Miriam", role: "Présence digitale", plan: "Growth", status: "verrouillé", accent: "amber", icon: "chat", photo: "/uploads/agents/miriam.jpg",
    ...
    {
      id: "serge", genre: "m", name: "Serge", role: "Organisation & agenda", plan: "Team", status: "verrouillé", accent: "growth", icon: "flag", photo: "/uploads/agents/serge.jpg",
    ...
    {
      id: "roland", genre: "m", name: "Roland", role: "Finance & marges", plan: "Team", status: "verrouillé", accent: "charbon", icon: "coins", photo: "/uploads/agents/roland.jpg",
    ...
    {
      id: "kofi", genre: "m", name: "Kofi", role: "Storytelling & Campagnes", plan: "Team", status: "verrouillé", accent: "info", icon: "trend", photo: "/uploads/agents/kofi.jpg",
    ...
    {
      id: "awa", genre: "f", name: "Awa", role: "Prospection & closing", plan: "Growth", status: "verrouillé", accent: "info", icon: "trend", photo: "/uploads/agents/awa.png",
      desc: "Elle rédige tes séquences de closing complètes et relance tes prospects sans que tu y penses.",
  ...
  forfaits: [
    {
      ...
      features: [
        { titre: "Mr Attractor — ton bras droit 24h/24", detail: "Répond en quelques secondes. Dis-lui ce que tu as en tête, il organise." },
        { titre: "20 messages/jour", detail: "+5 messages par ami invité grâce à ton lien de parrainage." },
        { titre: "Suivi Clients", detail: "Enregistre tes clients, leur historique d'achats, reçois des alertes inactivité." },
        { titre: "Calendrier & agenda", detail: "Tâches, rendez-vous, priorités — vue calendrier avec points colorés." },
    ...
    },
    {
      ...
      tagline: "Plus de limites. Ton équipe passe à l'action.",
      badge: "Débloque la vitesse",
      features: [
        { titre: "Messages illimités", detail: "Avec Mr Attractor et toute l'équipe Growth. Plus de compteur, plus de blocage." },
        { titre: "Mémoire long terme", detail: "Mr Attractor se souvient de tout entre les sessions. Il te connaît vraiment." },
        { titre: "Awa — Prospection & closing", detail: "Séquences de closing complètes, suivi de prospects, relances automatiques." },
        { titre: "Miriam — Présence digitale", detail: "Posts, broadcasts, réponses communauté — ta présence en ligne gérée." },
        { titre: "Carelle — Chief of Staff", detail: "Elle pilote tes projets, priorise et génère ta maquette d'app personnalisée." },
        { titre: "Décharge vocale", detail: "Parle à l'app. Whisper transcrit, Mr Attractor extrait tâches, rappels et idées." },
      ]
    },
    {
      id: "team", name: "Attractor Team", eur: "39 €", eurOld: "99 €", fcfa: "≈ 25 500 FCFA", period: "/ mois",
      tagline: "7 experts dans ta poche. Une agence sans les charges.", highlight: true, promo: "Promo fondateurs",
      features: [
        { titre: "Équipe complète débloquée", detail: "Serge (agenda), Roland (finances), Kofi (campagnes) — toute l'équipe Team." },
        ...
        { titre: "Tout le plan Growth inclus", detail: "Messages illimités, mémoire long terme, Awa, Miriam, Carelle." },
