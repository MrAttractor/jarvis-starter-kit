...
**Complément du 03/09/2026, même dossier, quatrième incident** : la parade « coller l'adresse en texte brut pour éviter la réécriture » a produit son propre défaut. Le 26/08, l'adresse a été écrite `demo.agenceattractor.com/elevia/app/` **sans le préfixe**, et le client de messagerie de la Cliente l'a complétée tout seul, **en `http://`**. Elle a ouvert un mail qui semblait envoyer son Club sur une adresse non sécurisée, et l'a signalé comme un point technique prioritaire. **Une adresse en texte brut s'écrit toujours avec son `https://`.** Sans schéma explicite, le logiciel du destinataire en invente un, et il choisit le mauvais.
